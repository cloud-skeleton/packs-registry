...
| **autoupdater** |`config`  | `ingress_worker_ips`                                    | "[]"                                                                               | JSON array of IPs for **ingress (Traefik) nodes**; used to add IP SANs to the **frontend (client)** cert. |
| **autoupdater** |`config`  | `main_worker_ips`                                       | "[]"                                                                               | JSON array of IPs for **backend/worker nodes**; used to add IP SANs to the **backend (server)** cert.     |
